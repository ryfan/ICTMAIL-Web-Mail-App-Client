            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark active" href="about.php" aria-expanded="false"><i class="mdi mdi-information-variant"></i><span class="hide-menu">Tentang</span></a>
                    </ul>
                </nav>
            </div>
        </aside>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <h2>Tentang Aplikasi</h2><hr>
                                <p style="text-align:justify">Halo <code><?php echo $_SESSION['email']; ?></code>!<br><br>
                                  <b><code>ICT Mail</code></b> merupakan Aplikasi pengiriman email yang sederhana. Moto "<i>Kirim Email Lebih Aman Menggunakan Kriptografi</i>",
                                  dengan itu kita menyadari bahwa pentingnya privasi dan keamanan data dalam berkomunikasi.<br><br>
                                  Aplikasi <code>ICT Mail</code> ini dibuat menggunakan bahasa pemrograman PHP
                                  dan meggunakan Algoritma <i>Advanced Encryption Standard</i> (AES) dan RC4 untuk menjaga kerahasiaan pesan.
