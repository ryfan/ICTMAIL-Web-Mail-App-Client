        ...
        <aside class="left-sidebar">
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark active" href="index.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <h1 style="text-align:center">Selamat Datang <code><?php echo $_SESSION['email']; ?></code> di ICT Mail</h1>
